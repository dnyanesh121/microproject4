...
var playAgainHurray = document.getElementById("playAgainHurray");
...
nextButton.addEventListener('click', function() {
    var hideAllElement = document.getElementById('mainPageContent');
    hideAllElement.classList.add('inactive');
...
playAgainHurray.addEventListener('click', function() {
    refresh();
})
